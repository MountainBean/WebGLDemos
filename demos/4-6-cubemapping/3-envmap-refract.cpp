...
#include "3-envmap-refract.glsl.h"
...
static void init(void) {
    ...
    sg_shader shd = sg_make_shader(refract_shader_desc(sg_query_backend()));
    ...
    layout.attrs[ATTR_refract_aPos].format = SG_VERTEXFORMAT_FLOAT3;
    layout.attrs[ATTR_refract_aNormal].format = SG_VERTEXFORMAT_FLOAT3;
