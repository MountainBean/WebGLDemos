...
static void init(void) {
    ...
    sg_shader greyscale_framebuffer_shd = sg_make_shader(greyscale_framebuffer_shader_desc(sg_query_backend()));
    ...
    offscreen::pip_cubes = sg_make_pipeline(sg_pipeline_desc {
        .shader = simple_shd,
        .layout = layout,
        .depth = {
    ...
    offscreen::pip_vegetation = sg_make_pipeline(sg_pipeline_desc {
        .shader = simple_shd,
        .layout = layout,
    ...
    state::pip = sg_make_pipeline(sg_pipeline_desc {
        .shader = greyscale_framebuffer_shd,
        .layout = layout,
...
void frame(void) {
    ...
    // Plane
    sg_apply_pipeline(offscreen::pip_cubes);
    ...
    // Vegetation
    sg_apply_pipeline(offscreen::pip_vegetation);
