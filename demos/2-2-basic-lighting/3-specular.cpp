...
static void init(void) {
    ...
    state::object_colour = glm::vec3(1.0f, 0.5f, 0.32f);
    state::light_colour = glm::vec3(1.0f);
    state::light_pos = glm::vec3(1.2f, 1.0f, 2.0f);
    ...
    layout.attrs[ATTR_specular_aPos].format = SG_VERTEXFORMAT_FLOAT3;
    layout.attrs[ATTR_specular_aNormal].format = SG_VERTEXFORMAT_FLOAT3;
...
void frame(void) {
    ...
    fs_params_t fs_params = {
        .objectColour {state::object_colour},
...
sapp_desc sokol_main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
    return sapp_desc {
        ...
        .height = 600,
        .high_dpi = true,
        .window_title = "Lighting - LearnOpenGL",
        .logger {
            .func = slog_func
        },
