...
#ifdef __clang__
// clangd doesn't like leaving struct elements valua initialised but its perfectly fine
...
static void init(void) {
    ...
    sgpld.layout.attrs[ATTR_simple_aColor].format = SG_VERTEXFORMAT_FLOAT3;
...
sapp_desc sokol_main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
    ...
    sad.height = 600;
    sad.high_dpi = true;
    sad.window_title = "Attributes - LearnOpenGL";
    return sad;
}
