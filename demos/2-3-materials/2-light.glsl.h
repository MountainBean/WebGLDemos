...
/*
    ...
    Cmdline:
        sokol-shdc -i .\2-light.glsl -o .\2-light.glsl.h -l glsl430:glsl300es
...
#error "Please include sokol_gfx.h before 2-light.glsl.h"
#endif
...
/*
    ...
    void main()
    {
        ...
        FragColor = vec4(fma(fs_light[3].xyz, fs_material[2].xyz * pow(max(dot(normalize(fs_params[2].xyz - FragPos), reflect(-_36, _29)), 0.0), fs_material[2].w), fma(fs_light[1].xyz, fs_material[0].xyz, fs_light[2].xyz * (fs_material[1].xyz * max(dot(_29, _36), 0.0)))), 1.0);
    }
...
/*
    ...
    void main()
    {
        ...
        FragColor = vec4(fs_light[3].xyz * (fs_material[2].xyz * pow(max(dot(normalize(fs_params[2].xyz - FragPos), reflect(-_36, _29)), 0.0), fs_material[2].w)) + (fs_light[1].xyz * fs_material[0].xyz + (fs_light[2].xyz * (fs_material[1].xyz * max(dot(_29, _36), 0.0)))), 1.0);
    }
